...
export type NumberFormData = Omit<
        ...
        <PageContainer>
            ...
            <Box sx={{ mb: 4, mt: -2, maxWidth: DESCRIPTION_MAX_WIDTH }}>
                <Typography variant="body-small">
                    Add a new number to handle incoming and outgoing calls. Use
                    this section to manage your numbers and control their settings.
                </Typography>
            </Box>
            ...
            <PageContainer.ContentForm methods={methods} formId={formId}>
                ...
                <SelectContext
                    ...
                    leadingIcon={null}
                    trailingIcon={isLoadingApplications ? <CircularProgress size={20} /> : null}
                    id={`${formId}-app-ref`}
