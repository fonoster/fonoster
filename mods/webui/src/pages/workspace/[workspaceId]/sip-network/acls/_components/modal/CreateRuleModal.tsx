...
const ruleSchema = z.object({
    ipOrCIDR: z.string()
        ...
        .refine(
            (value) => isValidIP(value) || isValidCIDR(value),
            {
                message: "Must be a valid IP (e.g., 192.168.1.1) or CIDR range (e.g., 192.168.1.0/24)"
            }
        ),
...
export default function CreateRuleModal({ open, onClose, onSave }: CreateRuleModalProps) {
