...
export const useACL = () => {
    ...
    const createAcl = async (data: CreateAclRequest): Promise<BaseApiObject | undefined> => {
        try {
            return await authentication.executeWithRefresh(() => _acls.createAcl(data));
        } catch (error: any) {
    ...
    const updateAcl = async (data: UpdateAclRequest): Promise<BaseApiObject | undefined> => {
        try {
            return await authentication.executeWithRefresh(() => _acls.updateAcl(data));
        } catch (error: any) {
            notifyError(error as ErrorType);
        }
    };

    const listAcls = async (data: ListAclsRequest = {
        pageSize: 10,
        pageToken: undefined
        ...
        try {
            ...
            return await authentication.executeWithRefresh(() => _acls.listAcls(data));
        } catch (error: any) {
            notifyError(error as ErrorType);
        }
    };
    ...
    const deleteAcl = async (ref: string): Promise<BaseApiObject | undefined> => {
        try {
            return await authentication.executeWithRefresh(() => _acls.deleteAcl(ref));
        } catch (error: any) {
            notifyError(error as ErrorType);
        }
    };
