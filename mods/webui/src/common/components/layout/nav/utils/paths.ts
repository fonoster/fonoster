...
export const paths = {
  ...
  workspaces: {
    ...
    sipNetwork: {
      ...
      trunks: (workspaceId: string) => `/workspace/${workspaceId}/sip-network/trunks`,
      numbers: (workspaceId: string) => `/workspace/${workspaceId}/sip-network/numbers`,
      domains: (workspaceId: string) => `/workspace/${workspaceId}/sip-network/domains`,
      agents: (workspaceId: string) => `/workspace/${workspaceId}/sip-network/agents`,
      acls: (workspaceId: string) => `/workspace/${workspaceId}/sip-network/acls`,
      credentials: (workspaceId: string) => `/workspace/${workspaceId}/sip-network/credentials`,
    },
