...
module.exports = {
  ...
  publicRuntimeConfig: {
    ...
    WEBUI_SENTRY_DSN: process.env.WEBUI_SENTRY_DSN,
    ...
    APP_TELEMETRY_ENABLED: process.env.APP_TELEMETRY_ENABLED,
    APP_FEATURE_FLAG_SEND_REGISTER: process.env.APP_FEATURE_FLAG_SEND_REGISTER,
    APP_TELEMETRY_MIXPANEL_TOKEN: process.env.APP_TELEMETRY_MIXPANEL_TOKEN,
  }
}
