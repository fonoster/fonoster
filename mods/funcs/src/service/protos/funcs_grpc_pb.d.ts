...
interface IFuncsService_IListFuncs
  extends grpc.MethodDefinition<
    funcs_pb.ListFuncsRequest,
    funcs_pb.ListFuncsResponse
  > {
...
interface IFuncsService_IGetFunc
  extends grpc.MethodDefinition<funcs_pb.GetFuncRequest, funcs_pb.Func> {
...
interface IFuncsService_ICreateFunc
  extends grpc.MethodDefinition<funcs_pb.CreateFuncRequest, funcs_pb.Func> {
...
interface IFuncsService_IUpdateFunc
  extends grpc.MethodDefinition<funcs_pb.UpdateFuncRequest, funcs_pb.Func> {
...
interface IFuncsService_IDeleteFunc
  extends grpc.MethodDefinition<funcs_pb.DeleteFuncRequest, common_pb.Empty> {
...
interface IFuncsService_IGetFuncLogs
  extends grpc.MethodDefinition<funcs_pb.GetFuncLogsRequest, funcs_pb.FuncLog> {
...
interface IFuncsService_ICreateRegistryToken
  extends grpc.MethodDefinition<
    funcs_pb.CreateRegistryTokenRequest,
    funcs_pb.CreateRegistryTokenResponse
  > {
...
export interface IFuncsServer {
  listFuncs: grpc.handleUnaryCall<
    funcs_pb.ListFuncsRequest,
    funcs_pb.ListFuncsResponse
  >;
  ...
  getFuncLogs: grpc.handleServerStreamingCall<
    funcs_pb.GetFuncLogsRequest,
    funcs_pb.FuncLog
  >;
  createRegistryToken: grpc.handleUnaryCall<
    funcs_pb.CreateRegistryTokenRequest,
    funcs_pb.CreateRegistryTokenResponse
  >;
}
...
export interface IFuncsClient {
  listFuncs(
    request: funcs_pb.ListFuncsRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: funcs_pb.ListFuncsResponse
    ) => void
  ...
  getFunc(
    request: funcs_pb.GetFuncRequest,
    callback: (error: grpc.ServiceError | null, response: funcs_pb.Func) => void
  ): grpc.ClientUnaryCall;
  getFunc(
    request: funcs_pb.GetFuncRequest,
    metadata: grpc.Metadata,
  ...
  createFunc(
    request: funcs_pb.CreateFuncRequest,
    callback: (error: grpc.ServiceError | null, response: funcs_pb.Func) => void
  ): grpc.ClientUnaryCall;
  createFunc(
    request: funcs_pb.CreateFuncRequest,
  ...
  updateFunc(
    request: funcs_pb.UpdateFuncRequest,
    callback: (error: grpc.ServiceError | null, response: funcs_pb.Func) => void
  ): grpc.ClientUnaryCall;
  updateFunc(
    request: funcs_pb.UpdateFuncRequest,
  ...
  deleteFunc(
    request: funcs_pb.DeleteFuncRequest,
    callback: (
      error: grpc.ServiceError | null,
  ...
  getFuncLogs(
    request: funcs_pb.GetFuncLogsRequest,
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<funcs_pb.FuncLog>;
  getFuncLogs(
    request: funcs_pb.GetFuncLogsRequest,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
  ...
  createRegistryToken(
    request: funcs_pb.CreateRegistryTokenRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: funcs_pb.CreateRegistryTokenResponse
    ) => void
  ): grpc.ClientUnaryCall;
  createRegistryToken(
    request: funcs_pb.CreateRegistryTokenRequest,
