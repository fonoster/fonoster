...
function serialize_fonos_funcs_v1alpha1_CreateFuncRequest(arg) {
  if (!(arg instanceof funcs_pb.CreateFuncRequest)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.CreateFuncRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function serialize_fonos_funcs_v1alpha1_CreateRegistryTokenRequest(arg) {
  if (!(arg instanceof funcs_pb.CreateRegistryTokenRequest)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.CreateRegistryTokenRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fonos_funcs_v1alpha1_CreateRegistryTokenRequest(
  buffer_arg
) {
  return funcs_pb.CreateRegistryTokenRequest.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function serialize_fonos_funcs_v1alpha1_CreateRegistryTokenResponse(arg) {
  if (!(arg instanceof funcs_pb.CreateRegistryTokenResponse)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.CreateRegistryTokenResponse"
    );
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fonos_funcs_v1alpha1_CreateRegistryTokenResponse(
  buffer_arg
) {
  return funcs_pb.CreateRegistryTokenResponse.deserializeBinary(
    new Uint8Array(buffer_arg)
  );
}
...
function serialize_fonos_funcs_v1alpha1_DeleteFuncRequest(arg) {
  if (!(arg instanceof funcs_pb.DeleteFuncRequest)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.DeleteFuncRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function serialize_fonos_funcs_v1alpha1_GetFuncLogsRequest(arg) {
  if (!(arg instanceof funcs_pb.GetFuncLogsRequest)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.GetFuncLogsRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function serialize_fonos_funcs_v1alpha1_GetFuncRequest(arg) {
  if (!(arg instanceof funcs_pb.GetFuncRequest)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.GetFuncRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function serialize_fonos_funcs_v1alpha1_ListFuncsRequest(arg) {
  if (!(arg instanceof funcs_pb.ListFuncsRequest)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.ListFuncsRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function serialize_fonos_funcs_v1alpha1_ListFuncsResponse(arg) {
  if (!(arg instanceof funcs_pb.ListFuncsResponse)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.ListFuncsResponse"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
...
function serialize_fonos_funcs_v1alpha1_UpdateFuncRequest(arg) {
  if (!(arg instanceof funcs_pb.UpdateFuncRequest)) {
    throw new Error(
      "Expected argument of type fonos.funcs.v1alpha1.UpdateFuncRequest"
    );
  }
  return Buffer.from(arg.serializeBinary());
}
