...
export interface IAgentsServer {
  listAgents: grpc.handleUnaryCall<
    agents_pb.ListAgentsRequest,
    agents_pb.ListAgentsResponse
  >;
  ...
  updateAgent: grpc.handleUnaryCall<
    agents_pb.UpdateAgentRequest,
    agents_pb.Agent
  >;
  deleteAgent: grpc.handleUnaryCall<
...
export interface IAgentsClient {
  listAgents(
    ...
    callback: (
      ...
      response: agents_pb.ListAgentsResponse
    ) => void
