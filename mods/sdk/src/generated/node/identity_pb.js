...
goog.exportSymbol('proto.fonoster.identity.v1beta2.SendVerificationCodeResponse', null, global);
...
goog.exportSymbol('proto.fonoster.identity.v1beta2.VerifyCodeResponse', null, global);
 ...
 * @constructor
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.fonoster.identity.v1beta2.SendVerificationCodeResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.displayName = 'proto.fonoster.identity.v1beta2.SendVerificationCodeResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.fonoster.identity.v1beta2.VerifyCodeResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.fonoster.identity.v1beta2.VerifyCodeResponse.displayName = 'proto.fonoster.identity.v1beta2.VerifyCodeResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.fonoster.identity.v1beta2.SendVerificationCodeResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.fonoster.identity.v1beta2.SendVerificationCodeResponse}
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.fonoster.identity.v1beta2.SendVerificationCodeResponse;
  return proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.fonoster.identity.v1beta2.SendVerificationCodeResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.fonoster.identity.v1beta2.SendVerificationCodeResponse}
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.fonoster.identity.v1beta2.SendVerificationCodeResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.prototype.getSuccess = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.fonoster.identity.v1beta2.SendVerificationCodeResponse} returns this
 */
proto.fonoster.identity.v1beta2.SendVerificationCodeResponse.prototype.setSuccess = function(value) {
 ...
 * @return {!Object}
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.fonoster.identity.v1beta2.VerifyCodeResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.fonoster.identity.v1beta2.VerifyCodeResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.fonoster.identity.v1beta2.VerifyCodeResponse}
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.fonoster.identity.v1beta2.VerifyCodeResponse;
  return proto.fonoster.identity.v1beta2.VerifyCodeResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.fonoster.identity.v1beta2.VerifyCodeResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.fonoster.identity.v1beta2.VerifyCodeResponse}
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.fonoster.identity.v1beta2.VerifyCodeResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.fonoster.identity.v1beta2.VerifyCodeResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {boolean}
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.prototype.getVerified = function() {
  return /** @type {boolean} */ (jspb.Message.getBooleanFieldWithDefault(this, 1, false));
};
...
/**
 * @param {boolean} value
 * @return {!proto.fonoster.identity.v1beta2.VerifyCodeResponse} returns this
 */
proto.fonoster.identity.v1beta2.VerifyCodeResponse.prototype.setVerified = function(value) {
  return jspb.Message.setProto3BooleanField(this, 1, value);
};
