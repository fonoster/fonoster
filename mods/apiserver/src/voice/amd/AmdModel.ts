...
// dist/voice/amd at runtime and src/voice/amd under tsx, so ../../../amd-model
// resolves to the package root in both.
 ...
 * inference failure; `runAmdProbe` turns that into a fail-open UNKNOWN verdict.
 */
