...
export const ASTERISK_SYSTEM_DOMAIN = e.APISERVER_ASTERISK_SYSTEM_DOMAIN || "sip.invalid";
...
export const IDENTITY_USER_VERIFICATION_REQUIRED =
  e.APISERVER_IDENTITY_USER_VERIFICATION_REQUIRED === "true";
...
export const IDENTITY_WORKSPACE_INVITATION_FAIL_URL =
  e.APISERVER_IDENTITY_WORKSPACE_INVITATION_FAIL_URL;
...
export const AUTHZ_SERVICE_ENABLED = e.APISERVER_AUTHZ_SERVICE_ENABLED === "true";
...
export const ROUTR_API_ENDPOINT = e.APISERVER_ROUTR_API_ENDPOINT || "routr:51907";
...
export const SMTP_PORT = e.APISERVER_SMTP_PORT ? parseInt(e.APISERVER_SMTP_PORT) : 587;
