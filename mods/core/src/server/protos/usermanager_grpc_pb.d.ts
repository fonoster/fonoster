...
interface IUserManagerService_IListUsers
  extends grpc.MethodDefinition<
    usermanager_pb.ListUsersRequest,
    usermanager_pb.ListUsersResponse
  > {
...
interface IUserManagerService_IGetUser
  extends grpc.MethodDefinition<
    usermanager_pb.GetUserRequest,
    usermanager_pb.User
  > {
...
interface IUserManagerService_ICreateUser
  extends grpc.MethodDefinition<
    usermanager_pb.CreateUserRequest,
    usermanager_pb.User
  > {
...
interface IUserManagerService_IUpdateUser
  extends grpc.MethodDefinition<
    usermanager_pb.UpdateUserRequest,
    usermanager_pb.User
  > {
...
interface IUserManagerService_IDeleteUser
  extends grpc.MethodDefinition<
    usermanager_pb.DeleteUserRequest,
    common_pb.Empty
  > {
...
export interface IUserManagerClient {
  listUsers(
    request: usermanager_pb.ListUsersRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: usermanager_pb.ListUsersResponse
    ) => void
  ...
  getUser(
    request: usermanager_pb.GetUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: usermanager_pb.User
    ) => void
  ): grpc.ClientUnaryCall
  getUser(
    request: usermanager_pb.GetUserRequest,
  ...
  createUser(
    request: usermanager_pb.CreateUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: usermanager_pb.User
    ) => void
  ...
  updateUser(
    request: usermanager_pb.UpdateUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: usermanager_pb.User
    ) => void
  ...
  deleteUser(
    request: usermanager_pb.DeleteUserRequest,
    callback: (
      error: grpc.ServiceError | null,
...
export class UserManagerClient extends grpc.Client
  implements IUserManagerClient {
  constructor (
    address: string,
