...
interface IProvidersService_IListProviders
...
interface IProvidersService_ICreateProvider
  extends grpc.MethodDefinition<
...
interface IProvidersService_IGetProvider
  extends grpc.MethodDefinition<
...
interface IProvidersService_IUpdateProvider
  extends grpc.MethodDefinition<
...
interface IProvidersService_IDeleteProvider
  extends grpc.MethodDefinition<
...
export interface IProvidersServer {
  listProviders: grpc.handleUnaryCall<
    providers_pb.ListProvidersRequest,
    providers_pb.ListProvidersResponse
  >
  createProvider: grpc.handleUnaryCall<
    providers_pb.CreateProviderRequest,
    providers_pb.Provider
  >
  getProvider: grpc.handleUnaryCall<
    providers_pb.GetProviderRequest,
    providers_pb.Provider
  >
  updateProvider: grpc.handleUnaryCall<
    providers_pb.UpdateProviderRequest,
    providers_pb.Provider
  >
  deleteProvider: grpc.handleUnaryCall<
    providers_pb.DeleteProviderRequest,
    common_pb.Empty
  >
}
...
export interface IProvidersClient {
  listProviders(
    request: providers_pb.ListProvidersRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: providers_pb.ListProvidersResponse
    ) => void
  ...
  createProvider(
    request: providers_pb.CreateProviderRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: providers_pb.Provider
    ) => void
  ): grpc.ClientUnaryCall
  createProvider(
    request: providers_pb.CreateProviderRequest,
  ...
  getProvider(
    request: providers_pb.GetProviderRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: providers_pb.Provider
    ) => void
  ...
  updateProvider(
    request: providers_pb.UpdateProviderRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: providers_pb.Provider
    ) => void
  ...
  deleteProvider(
    request: providers_pb.DeleteProviderRequest,
    callback: (
      error: grpc.ServiceError | null,
