...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.fonos.common.v1alpha1.Response.displayName = 'proto.fonos.common.v1alpha1.Response';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.fonos.common.v1alpha1.Response.prototype.toObject = function(opt_includeInstance) {
  return proto.fonos.common.v1alpha1.Response.toObject(opt_includeInstance, this);
};
 ...
 */
proto.fonos.common.v1alpha1.Response.toObject = function(includeInstance, msg) {
  var f, obj = {
...
proto.fonos.common.v1alpha1.Response.deserializeBinary = function(bytes) {
  ...
  return proto.fonos.common.v1alpha1.Response.deserializeBinaryFromReader(msg, reader);
};
 ...
 * @return {!proto.fonos.common.v1alpha1.Response}
 */
proto.fonos.common.v1alpha1.Response.deserializeBinaryFromReader = function(msg, reader) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.fonos.common.v1alpha1.Response.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f !== 0.0) {
    writer.writeEnum(
...
proto.fonos.common.v1alpha1.Response.prototype.getStatus = function() {
  return /** @type {!proto.fonos.common.v1alpha1.Response.Status} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
