...
interface IDomainsService_ICreateDomain
  extends grpc.MethodDefinition<
...
interface IDomainsService_IGetDomain
  extends grpc.MethodDefinition<
...
interface IDomainsService_IUpdateDomain
  extends grpc.MethodDefinition<
...
interface IDomainsService_IDeleteDomain
  extends grpc.MethodDefinition<
...
export interface IDomainsServer {
  listDomains: grpc.handleUnaryCall<
    domains_pb.ListDomainsRequest,
    domains_pb.ListDomainsResponse
  >
  createDomain: grpc.handleUnaryCall<
    domains_pb.CreateDomainRequest,
    domains_pb.Domain
  >
  getDomain: grpc.handleUnaryCall<
    domains_pb.GetDomainRequest,
    domains_pb.Domain
  >
  updateDomain: grpc.handleUnaryCall<
    domains_pb.UpdateDomainRequest,
    domains_pb.Domain
  >
  deleteDomain: grpc.handleUnaryCall<
    domains_pb.DeleteDomainRequest,
    common_pb.Empty
  >
}
...
export interface IDomainsClient {
  listDomains(
    ...
    callback: (
      ...
      response: domains_pb.ListDomainsResponse
    ) => void
