...
interface IStorageService_IUploadObject
  extends grpc.MethodDefinition<
    storage_pb.UploadObjectRequest,
    storage_pb.UploadObjectResponse
  > {
...
interface IStorageService_IGetObjectURL
  extends grpc.MethodDefinition<
    storage_pb.GetObjectURLRequest,
    storage_pb.GetObjectURLResponse
  > {
...
export interface IStorageServer {
  uploadObject: grpc.handleClientStreamingCall<
    storage_pb.UploadObjectRequest,
    storage_pb.UploadObjectResponse
  >
  getObjectURL: grpc.handleUnaryCall<
    storage_pb.GetObjectURLRequest,
    storage_pb.GetObjectURLResponse
  >
}
...
export interface IStorageClient {
  uploadObject(
    callback: (
      ...
      response: storage_pb.UploadObjectResponse
    ) => void
  ): grpc.ClientWritableStream<storage_pb.UploadObjectRequest>
  uploadObject(
  ...
  getObjectURL(
    request: storage_pb.GetObjectURLRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: storage_pb.GetObjectURLResponse
    ) => void
