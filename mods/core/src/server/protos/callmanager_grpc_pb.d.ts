...
interface ICallManagerService_ICall
  extends grpc.MethodDefinition<
    callmanager_pb.CallRequest,
    callmanager_pb.CallResponse
  > {
...
export interface ICallManagerClient {
  call(
    request: callmanager_pb.CallRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: callmanager_pb.CallResponse
    ) => void
...
export class CallManagerClient extends grpc.Client
