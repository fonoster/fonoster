...
function serialize_yaps_appmanager_v1alpha1_CreateAppRequest (arg) {
  if (!(arg instanceof appmanager_pb.CreateAppRequest)) {
    throw new Error(
      'Expected argument of type yaps.appmanager.v1alpha1.CreateAppRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
function serialize_yaps_appmanager_v1alpha1_DeleteAppRequest (arg) {
  if (!(arg instanceof appmanager_pb.DeleteAppRequest)) {
    throw new Error(
      'Expected argument of type yaps.appmanager.v1alpha1.DeleteAppRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
function serialize_yaps_appmanager_v1alpha1_GetAppRequest (arg) {
  if (!(arg instanceof appmanager_pb.GetAppRequest)) {
    throw new Error(
      'Expected argument of type yaps.appmanager.v1alpha1.GetAppRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
function serialize_yaps_appmanager_v1alpha1_ListAppsRequest (arg) {
  if (!(arg instanceof appmanager_pb.ListAppsRequest)) {
    throw new Error(
      'Expected argument of type yaps.appmanager.v1alpha1.ListAppsRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
function serialize_yaps_appmanager_v1alpha1_ListAppsResponse (arg) {
  if (!(arg instanceof appmanager_pb.ListAppsResponse)) {
    throw new Error(
      'Expected argument of type yaps.appmanager.v1alpha1.ListAppsResponse'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
function serialize_yaps_appmanager_v1alpha1_UpdateAppRequest (arg) {
  if (!(arg instanceof appmanager_pb.UpdateAppRequest)) {
    throw new Error(
      'Expected argument of type yaps.appmanager.v1alpha1.UpdateAppRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
//# sourceMappingURL=appmanager_grpc_pb.js.map
