...
function serialize_fonos_providers_v1alpha1_CreateProviderRequest (arg) {
  if (!(arg instanceof providers_pb.CreateProviderRequest)) {
    throw new Error(
      'Expected argument of type fonos.providers.v1alpha1.CreateProviderRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
function deserialize_fonos_providers_v1alpha1_CreateProviderRequest (
  buffer_arg
) {
...
function serialize_fonos_providers_v1alpha1_DeleteProviderRequest (arg) {
  if (!(arg instanceof providers_pb.DeleteProviderRequest)) {
    throw new Error(
      'Expected argument of type fonos.providers.v1alpha1.DeleteProviderRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
function deserialize_fonos_providers_v1alpha1_DeleteProviderRequest (
  buffer_arg
) {
...
function serialize_fonos_providers_v1alpha1_GetProviderRequest (arg) {
  if (!(arg instanceof providers_pb.GetProviderRequest)) {
    throw new Error(
      'Expected argument of type fonos.providers.v1alpha1.GetProviderRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
function serialize_fonos_providers_v1alpha1_ListProvidersRequest (arg) {
  if (!(arg instanceof providers_pb.ListProvidersRequest)) {
    throw new Error(
      'Expected argument of type fonos.providers.v1alpha1.ListProvidersRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
function deserialize_fonos_providers_v1alpha1_ListProvidersRequest (
  buffer_arg
) {
...
function serialize_fonos_providers_v1alpha1_ListProvidersResponse (arg) {
  if (!(arg instanceof providers_pb.ListProvidersResponse)) {
    throw new Error(
      'Expected argument of type fonos.providers.v1alpha1.ListProvidersResponse'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
function deserialize_fonos_providers_v1alpha1_ListProvidersResponse (
  buffer_arg
) {
...
function serialize_fonos_providers_v1alpha1_Provider (arg) {
  if (!(arg instanceof providers_pb.Provider)) {
    throw new Error(
      'Expected argument of type fonos.providers.v1alpha1.Provider'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
...
function serialize_fonos_providers_v1alpha1_UpdateProviderRequest (arg) {
  if (!(arg instanceof providers_pb.UpdateProviderRequest)) {
    throw new Error(
      'Expected argument of type fonos.providers.v1alpha1.UpdateProviderRequest'
    )
  }
  return Buffer.from(arg.serializeBinary())
}
function deserialize_fonos_providers_v1alpha1_UpdateProviderRequest (
  buffer_arg
) {
