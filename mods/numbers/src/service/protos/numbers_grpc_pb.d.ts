...
interface INumbersService_ICreateNumber
  extends grpc.MethodDefinition<
...
interface INumbersService_IGetIngressApp
  extends grpc.MethodDefinition<
...
interface INumbersService_IGetNumber
  extends grpc.MethodDefinition<
...
interface INumbersService_IUpdateNumber
  extends grpc.MethodDefinition<
...
interface INumbersService_IDeleteNumber
  extends grpc.MethodDefinition<
...
export interface INumbersServer {
  listNumbers: grpc.handleUnaryCall<
    numbers_pb.ListNumbersRequest,
    numbers_pb.ListNumbersResponse
  >;
  createNumber: grpc.handleUnaryCall<
    numbers_pb.CreateNumberRequest,
    numbers_pb.Number
  >;
  getIngressApp: grpc.handleUnaryCall<
    numbers_pb.GetIngressAppRequest,
    appmanager_pb.App
  >;
  getNumber: grpc.handleUnaryCall<
    numbers_pb.GetNumberRequest,
    numbers_pb.Number
  >;
  updateNumber: grpc.handleUnaryCall<
    numbers_pb.UpdateNumberRequest,
    numbers_pb.Number
  >;
  deleteNumber: grpc.handleUnaryCall<
    numbers_pb.DeleteNumberRequest,
    common_pb.Empty
  >;
}
...
export interface INumbersClient {
  listNumbers(
    ...
    callback: (
      ...
      response: numbers_pb.ListNumbersResponse
    ) => void
  ...
  getIngressApp(
    request: numbers_pb.GetIngressAppRequest,
    callback: (
      error: grpc.ServiceError | null,
