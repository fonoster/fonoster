...
class InitCommand extends Command {
  async run() {
    ...
    const answers = await inquirer.prompt([
      {name:'pckgName', message: 'package name', type: 'input', default: dirname},
      {name:'pckgVersion', message: 'version', type: 'input', default: '1.0.0'},
      {name:'pckgDesc', message: 'description', type: 'input'},
      {name:'entryPoint', message: 'entry point', type: 'input', default: 'src/index.js'},
      {name:'bucket', message: 'bucket name', type: 'input', default: 'default'},
      ...
      {name:'confirm', message: 'does everything look good?', type: 'confirm'}
    ])
