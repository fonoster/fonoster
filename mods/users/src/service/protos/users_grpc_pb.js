...
function serialize_fonos_users_v1beta1_CreateUserCredentialsRequest(arg) {
  if (!(arg instanceof users_pb.CreateUserCredentialsRequest)) {
    throw new Error('Expected argument of type fonos.users.v1beta1.CreateUserCredentialsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fonos_users_v1beta1_CreateUserCredentialsRequest(buffer_arg) {
  return users_pb.CreateUserCredentialsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_fonos_users_v1beta1_CreateUserCredentialsResponse(arg) {
  if (!(arg instanceof users_pb.CreateUserCredentialsResponse)) {
    throw new Error('Expected argument of type fonos.users.v1beta1.CreateUserCredentialsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_fonos_users_v1beta1_CreateUserCredentialsResponse(buffer_arg) {
...
createUserCredentials: {
    ...
    requestSerialize: serialize_fonos_users_v1beta1_CreateUserCredentialsRequest,
    requestDeserialize: deserialize_fonos_users_v1beta1_CreateUserCredentialsRequest,
    responseSerialize: serialize_fonos_users_v1beta1_CreateUserCredentialsResponse,
    responseDeserialize: deserialize_fonos_users_v1beta1_CreateUserCredentialsResponse,
  },
};
