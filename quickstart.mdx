...
<CardGroup cols={2}>
  <Card title="Programmable Voice" icon="rocket-launch" color="#5765F2" href="https://discord.com/invite/4QWgSz4hTC">
    Learn more about the Programmable Voice API and how to build advanced voice applications.
  </Card>

  <Card title="SDKs" icon="code" color="#5765F2" href="https://discord.com/invite/4QWgSz4hTC">
