---
title: 'Quickstart'
description: 'Learn how to get started with Fonoster.'
---

Before integrating Fonoster into your application, you need an account to set up the command-line interface and link a virtual phone number. This guide walks you through those steps.
