...
<CardGroup cols={2}>
  <Card title="SDK" icon="code" color="#C53635" href="https://www.npmjs.com/package/@fonoster/sdk">
    SDK documentation at NPM.
  </Card>

  <Card title="Command-Line" icon="square-terminal" color="#C53635" href="https://www.npmjs.com/package/@fonoster/ctl">
