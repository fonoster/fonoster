...
<CardGroup cols={2}>
  ...
  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#000000" href="https://twitter.com/fonoster" class="block dark:hidden">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>

  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#FFFFFF" href="https://twitter.com/fonoster" class="hidden" class="hidden dark:block">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>
