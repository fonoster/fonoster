...
<CardGroup cols={2}>
  <Card title="Join our Discord server" icon="discord" iconType="brand" href="https://discord.com/invite/4QWgSz4hTC">
    The #get-help channel is a great place to get help with any questions about Fonoster.
  </Card>

  <Card title="Follow us on X (Twitter)" icon="x" iconType="brand" href="https://twitter.com/fonoster">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>

  <Card title="Schedule a call" icon="phone" href="https://mintlify.com/docs/content/components/accordions">
    Arrange a call with the team. We can help answer questions and give a 1-on-1 help building on Fonoster.
  </Card>

  <Card title="Give us a start on GitHub" icon="stars" href="https://github.com/fonoster/fonoster">
