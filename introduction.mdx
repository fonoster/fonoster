...
With Fonoster, you can build anything from simple IVR applications to advanced ones with LLM. Check out a demo below for a glance at what you can build.

<iframe width="100%" height="calc(100vw/1.77)" src="https://www.youtube.com/embed/hFOTzboLPnw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
...
<CardGroup cols={2}>
  ...
  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#FFFFFF" iconType="brands" href="https://twitter.com/fonoster">
