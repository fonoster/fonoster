...
<CardGroup cols={2}>
  ...
  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#000000" iconType="brands" className="hidden dark:hidden" href="https://twitter.com/fonoster">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>

  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#FFFFFF" iconType="brands" className="hidden dark:block" href="https://twitter.com/fonoster">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>

  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#FFFFFF" iconType="solid" href="https://twitter.com/fonoster">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>

  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#FFFFFF" iconType="light" href="https://twitter.com/fonoster">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>
