...
<img className="block h-32 dark:hidden" src="/logo/light.jpg" />
<img className="hidden h-32 dark:block" src="/logo/dark" />
...
<CardGroup cols={2}>
  ...
  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#000000" href="https://twitter.com/fonoster">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>

  <Card title="Follow us on X (Twitter)" icon="x-twitter" color="#FFFFFF" href="https://twitter.com/fonoster" class="hidden">
    Follow us on X (Twitter) for the latest updates and news.
  </Card>
