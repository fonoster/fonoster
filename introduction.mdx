...
<CardGroup cols={2}>
  <Card title="Join our Discord server" icon="discord" iconType="brands" href="https://discord.com/invite/4QWgSz4hTC">
  ...
  <Card title="Give us a start on GitHub" icon="stars" iconType="solid" iconColor="#FBBF24" href="https://github.com/fonoster/fonoster">
