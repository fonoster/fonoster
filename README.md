...
Project Fonos is open-source communications for the cloud. This repository assembles various components needed to deploy a telephony system. It helps VoIP integrators quickly deploy new networks and include value-added services such as Programmable Voice, Messaging, and Video.
