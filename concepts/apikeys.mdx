...
You can differentiate API keys' Access Key ID from Workspace's Access Key ID by the prefix "AP" (Workspace's Access Key ID has the "WO" prefix, and User's Access Key ID has the "US" prefix).
