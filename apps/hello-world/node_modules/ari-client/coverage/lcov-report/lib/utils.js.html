...
&nbsp;
  bodyParams.forEach(function(bodyParam) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (jsonBody) {
      // variables behaves differently in that it expects a variables key to
      // wrap the key/value pairs
      <span class="missing-if-branch" title="else path not taken" >E</span>if (bodyParam.name === 'variables' &amp;&amp; !options.variables.variables) {
